...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        if opt.resume_evolve is not None:
            ...
            with open(ROOT / opt.resume_evolve, errors="ignore", encoding="utf-8") as f:
        ...
        # If not resuming from a previous checkpoint, generate initial values from .yaml files in opt.evolve_population
            ...
            for file_name in yaml_files:
                with open(os.path.join(opt.evolve_population, file_name), encoding="utf-8") as yaml_file:
        ...
        for generation in range(opt.evolve):
            if generation >= 1:
                ...
                with open(save_dir / "evolve_population.yaml", "w", encoding="utf-8") as outfile:
